        ...
        <div style={{display: daysWeatherDropdown ? "block" : "none"}} className="app-wrapper nipple nipple-top-right">
            ...
            <div className="app weather-app ">
                ...
                <section className="weather-current">
                    ...
                    <header className="weather-current-header">
                        ...
                        <div className="weather-current-location">
                            ...
                            <div className={`weather-location ${editWeather ? "hide-weather-location" : ""}`}>

                                <span className="weather-location-name" title={weather && weather.location && weather.location.AdministrativeArea && weather.location.AdministrativeArea.EnglishName} data-test="location-name">{weather && weather.location && weather.location.AdministrativeArea && weather.location.AdministrativeArea.EnglishName}</span>

                                <i className="loading-icon"></i>

                                <span onClick={toggleEditWeather} className="weather-location-icon weather-location-edit" data-test="edit-icon">
                            ...
                            <div className={`current-location-group ${editWeather ? "display-edit-location" : ""}`}>
                                ...
                                <div className="edit-location-dropdown typeahead">
                                    ...
                                    <ul className="location-dropdown-list" data-test="weather-location-results">
                                        {/* <li data-id="Virginia, United States" data-index="0" data-offset="undefined" class="hover">
                                            <span class="location-result">Virginia, United States</span>
                                        </li> */}
                                            ...
                                            editLocation && editLocation.map((location, index) => {
                                                return (
                                                    <li data-id={location.LocalizedName} key={index} data-index={index} data-offset="undefined" class="hover">
                                                        <span class="location-result">{location.LocalizedName}</span>
                                                    </li>
                                                )
                                            })
                            ...
                            <span className={`weather-current-conditions ${editWeather ? "hide-weather-location" : ""}`}>{dropDownCurrentWeather && dropDownCurrentWeather.Day && dropDownCurrentWeather.Day.IconPhrase}</span>
                        ...
                        <div onClick={toggleWeatherDailyMore} className="current-location-more">
                            ...
                            <div className="icon-wrapper current-location-more-toggle" data-test="more">
                                ...
                                <svg className={`icon icon-ellipsis more-icon ${editWeather ? "hide-more-icon" : ""}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60">
                ...
                <section className="weather-row weather-attribution">
                    ...
                    <a className="weather-attribution-link" href="https://www.accuweather.com/en/ng/apapa/942887/current-weather/942887?lang=en-us&amp;partner=momentum" target="_blank" rel="noreferrer">
                        
                        <img className="weather-attribution-logo" src={`${process.env.PUBLIC_URL + "/img/logo-accuweather.png"}`} alt="accurweather" /> More weather →
