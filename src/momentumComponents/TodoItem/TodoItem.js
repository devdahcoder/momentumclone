  ...
  return (
    <div className="todo-list-item-container" >
      ...
      <span className="side-col todo-delete-container">
        <span onClick={() => dispatch(deleteTodo(id))} style={{opacity: completed ? "1" : ""}} data-test="delete" className="control todo-delete">
          <span style={{transform: completed ? "rotate(45deg)" : ""}} className="icon-wrapper dash-icon-wrapper">
