...
const Time = () => {
	...
	return (
		<div
			data-testid="time-section-container"
			...
			<div className="time-section-wrapper">
				<div className="time-section-display">
					<div className="side-col more-time-left">
						<div
							className="more more-time-container"
							onClick={toggleDisplayOtherTimeDropDown}
						>
							<div className="icon-wrapper more-dash-icon-wrapper more-toggle">
								<svg
									...
									className="active-mode more-dash-icon time-icon"
									style={{
										opacity: toggleOtherTimeDropDown
											? "1"
											: "",
									}}
								>
					...
					<div className="side-col time-right">
						<div
							className="more more-dash"
							style={{ position: "relative" }}
						>
							<div
								onClick={toggleDisplayDigitalTimeDropDown}
								onBlur={toggleDisplayDigitalTimeDropDown}
								className="icon-wrapper dash-icon-wrapper more-toggle"
							>
								<svg
									data-v-c8d4d4da=""
									style={{
										opacity: toggleDigitalTimeDropDown
											? "1"
											: "",
									}}
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 60 60"
									className="more-icon time-icon"
								>
									<path
										data-v-c8d4d4da=""
