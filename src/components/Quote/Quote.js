...
const Quote = () => {
    ...
    return (
		<div
			data-testid="footer-center-container"
			className="footer-center-container"
		>
			<div className="footer-center-display">
				<p className="footer-center-text-container">
					<span className="footer-center-body-text">
						{quote && quote.content}
					</span>

					<span className="footer-center-text-below">
						<span className="footer-center-text-below-name">
							{quote && quote.author}
						</span>
						...
						<span
							title="like"
							data-test="like"
							className="control control-heart"
						>
							<svg
							...
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="icon icon-dash-heart"
								viewBox="0 0 953 1000"
								fill="#fff"
							>
						...
						<span
							...
							data-test="skip"
							title="Skip Quote"
							className="control control-skip"
						>
							<span
								data-v-f7053094=""
								className="skip-icon-container"
							>
								<svg
									data-v-f7053094=""
									xmlns="http://www.w3.org/2000/svg"
						...
						<span
							...
							title="share"
							data-test="share"
							className="control control-twitter"
						>
							<svg
