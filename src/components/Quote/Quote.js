                ...
                <p className="footer-center-text-container">
                    ...
                    <span className="footer-center-text-below">
                        ...
                        <span title="like" data-test="like" className="control control-heart">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-heart" viewBox="0 0 953 1000" fill="#fff">
                        ...
                        <span onClick={getQuote} data-v-f7053094="" data-test="skip" title="Skip Quote" className="control control-skip">
                            ...
                            <span data-v-f7053094="" className="skip-icon-container">
                                ...
                                <svg data-v-f7053094="" xmlns="http://www.w3.org/2000/svg" className="icon icon-skip" viewBox="0 0 249.05 132.12" className="icon icon-skip">
